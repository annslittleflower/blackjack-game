const Instructions = () => {
	return (
		<div className='instructions'>
			...
			<ul>
				<li>
					Hit: You are dealt one more card to add to your point value. For this
					project, the player may hit as many times as they like, until their
					card value exceeds 21, at which point the game ends in an automatic
					loss
				</li>
				<li>
					Stand: Ends the round (for the purposes of this project, this will end
					the game)
				</li>
			</ul>
			<p>
			...
			<p>You win if:</p>
			<ul>
				<li>your current total is &lt; 21 but higher than the House’s total</li>
				<li>your current total is 21 and the House’s total is not 21</li>
			</ul>
			<p>You lose if:</p>
			<ul>
				<li>your current total totals over 21</li>
				<li>your current total is &lt; 21 but lower than the House’s total</li>
